 ...
 */
export function mountMarquee(container, { onSelect, isEmptyTarget, onEmptyClick }) {
  let start = null;
  let rectEl = null;
  ...
  function up(e) {
    ...
    else if (onEmptyClick) onEmptyClick(); // a click (not a drag) on empty canvas → deselect
  }

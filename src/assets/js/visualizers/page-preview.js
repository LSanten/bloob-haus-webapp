(() => {
  // lib/visualizers/page-preview/browser.js
  (function() {
    var EYE_ICON = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>';
    var overlay = document.createElement("div");
    overlay.className = "preview-overlay";
    overlay.innerHTML = '<div class="preview-modal"><button class="preview-close" aria-label="Close preview">&times;</button><div class="preview-content"></div><a class="preview-goto" href="#">Go to page</a></div>';
    ...
    function openPreview(url) {
      ...
      fetch(url).then(function(res) {
        ...
        if (recipe) {
          ...
          content.innerHTML = main ? main.innerHTML : "<p>Could not load preview.</p>";
        }
        modal.scrollTop = 0;
      }).catch(function() {
    ...
    function addButtonsToStatic() {
      document.querySelectorAll(".recipe-card-link").forEach(function(link) {
        ...
        if (!url || !url.startsWith("/") || url.startsWith("/tags/") || url.startsWith("/search/"))
          return;
...
//# sourceMappingURL=page-preview.js.map

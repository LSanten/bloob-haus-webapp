...
/**
 * @param {{ items: {quote: string, name: string, date: string, color: string}[], limit: number|null }} parsed
 * @returns {string} HTML string
 */
export function render({ items, limit }) {
  ...
  // Desktop: Swiper slides (all visible — Swiper handles scroll)
...
${mobileCards}
        ...
        <div class="swiper musings__container-desktop" id="musings-swiper">

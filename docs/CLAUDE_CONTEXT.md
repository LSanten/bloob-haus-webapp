...
**Build pipeline:**
```bash
npm run build    # Full build: bundle visualizers → clone → preprocess → eleventy
...
│   │   └── eleventyComputed.js  ✅ Slugified permalinks
│   ├── _includes/
│   │   ├── layouts/
│   │   │   ├── base.njk         ✅ Base HTML layout
│   │   │   ├── page.njk         ✅ Content page layout
│   │   │   └── list.njk         ✅ Section listing layout
│   │   └── partials/
│   │       ├── head.njk         ✅ <head> with meta, RSS, fonts
│   │       ├── nav.njk          ✅ Auto-detected section nav
│   │       ├── footer.njk       ✅ Site footer
│   │       ├── scripts.njk      ✅ Visualizer JS includes
│   │       └── backlinks.njk    ✅ Backlinks partial
│   ├── assets/
│   │   ├── css/main.css         ✅ Main stylesheet
│   │   ├── css/visualizers/     ✅ Visualizer styles (generated)
│   │   └── js/visualizers/      ✅ Visualizer scripts (generated)
│   ├── media/                   ← Images (generated by preprocessor)
│   ├── index.njk                ✅ Homepage
│   ├── recipes/index.njk        ✅ Recipe listing
│   ├── notes/index.njk          ✅ Notes listing
│   ├── resources/index.njk      ✅ Resources listing
│   ├── lists-of-favorites/index.njk ✅ Favorites listing
│   ├── feed.njk                 ✅ RSS/Atom feed
│   ├── sitemap.njk              ✅ XML sitemap
│   ├── robots.njk               ✅ robots.txt
│   ├── 404.njk                  ✅ Custom 404 page
│   ├── recipes/*.md             ← Generated content (gitignored)
│   ├── notes/*.md               ← Generated content (gitignored)
│   └── ...
│
...
- **`BUILD_TARGET` lazy getter** — ESM import timing means module-level env reads are too early

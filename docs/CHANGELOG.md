...
- **Not done / needs Leon:** the visitor counter is inert until (1) `show_visitor_count: true` in the melt vault's `_bloob-settings.md` and (2) the GoatCounter admin switch. Nothing was pushed, per request.

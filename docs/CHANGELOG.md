...
- **New debt:** TECH-DEBT #46 — `garden` splits attributes on whitespace, so `src:Contact us.png` has never parsed. It already required encoding, which is corroboration that the old rule was the outlier.
